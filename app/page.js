  ...
  return (
    <main>
      <section className="hero">
        <div className="heroDecor decorHeart1">♡</div>
        <div className="heroDecor decorHeart2">♡</div>
        <div className="heroDecor decorSpark">✦</div>
        <div className="heroDecor decorHeart3">♡</div>
